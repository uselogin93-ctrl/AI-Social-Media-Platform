    ...
    <main className="min-h-screen flex-grow flex items-center justify-center p-6 relative overflow-hidden bg-background">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="font-headline text-4xl font-extrabold tracking-tighter text-on-surface mb-2">Join Editorial</h1>
          <p className="text-on-surface-variant font-medium tracking-tight">Step into the future of social AI.</p>
        </div>
